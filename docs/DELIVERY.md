...
`https://cdn.jsdelivr.net/npm/@archmap/core@0.1.2/dist/archmap.js`.
...
```bash
npm view @archmap/core@0.1.2 version license files
```
...
```text
https://cdn.jsdelivr.net/npm/@archmap/core@0.1.2/dist/archmap.js
https://cdn.jsdelivr.net/npm/@archmap/core@0.1.2/dist/controls/diagram-tags.js
https://cdn.jsdelivr.net/npm/@archmap/core@0.1.2/dist/views3d/three-view.js
```
